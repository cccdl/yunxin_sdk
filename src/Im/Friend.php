...
class Friend extends Base
{
     ...
     * @throws Exception
     */
    public function update(string $accid, string $faccid, string $alias = '', string $ex = '', string $serverex = '')
    {
     ...
     * @throws Exception
     */
    public function delete(string $accid, string $faccid, bool $isDeleteAlias = false)
    {
     ...
     * @throws Exception
     */
    public function get(string $accid, int $updateTime): array
    {
     ...
     * @throws Exception
     */
    public function listBlackAndMuteList(string $accid): array
    {
